---
title: "Appels masqués : comment identifier qui t'appelle en secret"
...
Ton téléphone sonne. L'écran affiche numéro privé ou appel masqué. Tu hésites à décrocher, tu as peur de rater une urgence ou de tomber sur un plaisantin. Ne subis plus cette situation désagréable. Il existe des méthodes simples et accessibles pour découvrir qui se cache derrière ces appels anonymes.
...
Truecaller est la plus populaire. Elle identifie les numéros inconnus et te prévient immédiatement s'il s'agit d'un démarchage commercial ou d'une arnaque. Tu installes l'application, tu lui donnes les autorisations nécessaires, et elle affiche le nom de l'appelant, même s'il n'est pas enregistré dans tes contacts.

Eyecon est une autre alternative intéressante. Cette application va plus loin en associant des photos et des profils de réseaux sociaux aux numéros de téléphone. Elle te permet de voir le visage de la personne qui cherche à te joindre.

Hiya est également très efficace pour bloquer les appels indésirables et analyser l'origine des numéros suspects.

Pour que ces applications fonctionnent correctement, tu dois disposer d'une connexion internet active, en données mobiles ou en Wi-Fi, au moment où le téléphone sonne.
...
Une autre méthode consiste à demander un relevé de compte détaillé de tes communications. À la fin du mois, certains opérateurs listent tous les appels reçus sur ta ligne, y compris ceux qui s'affichaient en masqué sur ton écran. Cette option est parfois payante mais reste très efficace si tu as besoin de preuves écrites.
...
Sur un téléphone Android, ouvre l'application Téléphone, va dans les Paramètres, puis dans la section Bloquer des numéros. Active simplement l'option Bloquer les appels de numéros inconnus ou masqués.

Sur un iPhone, va dans les Réglages, puis dans Téléphone. Active l'option Appels d'inconnus silencieux. Les appels masqués ne feront plus sonner ton téléphone et seront directement redirigés vers ta messagerie vocale.

## Passe à l'action dès aujourd'hui

Ne laisse plus les appels anonymes perturber tes journées et ton travail. Choisis ta méthode maintenant. Télécharge une application d'identification comme Truecaller pour démasquer les prochains appels en direct. Si tu veux la paix totale, configure dès aujourd'hui les réglages de ton smartphone pour bloquer définitivement les numéros masqués. Prends le contrôle de tes communications.
